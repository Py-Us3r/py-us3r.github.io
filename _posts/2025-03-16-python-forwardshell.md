---
layout: single
title: Forward Shell - Python
excerpt: "Forward Shell Script."
date: 2025-03-16
classes: wide
header:
...
class ForwardShell():
  ...
  def __init__(self):
    ...
    self.help_options = {'enum suid': 'FileSystem SUID Privileges Enumeration', 'help': 'Show this help pannel'}
  ...
  def run(self):
    ...
    while True:
      command = input(colored(" NoC >> ", "yellow"))
